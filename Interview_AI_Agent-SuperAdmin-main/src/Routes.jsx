...
import RecentInterviews from "./pages/RecentInterviews/RecentInterviews";
...
const JobSeekerPopup = lazy(() => import("./components/Popups/JobSeekerPopup"));
                ...
                <Routes>
                    <Route element={<AnalyticsWrapper />}>
                        ...
                        <Route element={<UserWrapper />}>
                            ...
                            <Route path="/manage-admin" element={<ManageUsers />} />
...
const UserWrapper = () => {
    ...
    useEffect(() => {
        if (!ls.get("AI_SA_token")) navigate("/", { replace: true });
    }, []);
