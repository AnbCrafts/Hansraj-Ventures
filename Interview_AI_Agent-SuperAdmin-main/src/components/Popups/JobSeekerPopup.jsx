...
import styles from "./JobSeekerPopup.module.scss";
import { FaCopy } from "react-icons/fa";
import { IoCheckmarkDoneSharp } from "react-icons/io5";

const JobSeekerPopup = () => {
            ...
            <div className={styles.Wrapper} onClick={(e) => e.stopPropagation()}>
                ...
                <div className={styles.Row2}>
                    ...
                    <div className={styles.Right}>
                        <div className={styles.InputWrapper}>
                            <label htmlFor="prof">Register data and time</label>
                            <input type="text" id="prof" readOnly value={formatDate(activeData?.created_at)} />
                        </div>
                ...
                {activeData?.recent_interview?.id ? (
                    <div className={styles.InterviewDetails}>
                        ...
                        {/* <p>Scheduled Time : {activeData?.recent_interview?.scheduled_time}</p> */}
