...
const Candidate04 = ({ setSkillPopup, allSkillsOption, setSkills, skillDetails, setSkillDetails }) => {
	...
	const handelSave = () => {
		...
		setSkillPopup(false);
		setSkills(skillDetails[0]?.skills)
		// console.log(skillDetails[0]?.skills);
	}
