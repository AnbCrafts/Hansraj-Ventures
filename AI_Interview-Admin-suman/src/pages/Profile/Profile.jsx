...
const Profile = () => {
    ...
    const handlePasswordChange = async () => {
        try {
            ...
            if (passwords.newPassword !== passwords.confirmPassword) return toast.warn("Password doesn't match");
    ...
    const handleProfileChange = (e) => {
        ...
        //     if (!regex.test(value)) return toast.warn("Username can only contain letters, numbers, and underscores.");
        // }
        setProfile((prevData) => ({
            ...prevData,
            [name]: value,
            ...
            <div className={styles.Bottom}>
                <div className={styles.Profile}>
                    <div className={styles.InputWrapper}>
                        ...
                        <div className={styles.Input}>
                            <input
                                type="text"
                                name="name"
                                value={profile?.name || "No Full Name"}
                    ...
                    <div className={styles.InputWrapper}>
                        ...
                        <div className={styles.Input}>
                            {" "}
                            <input type="text" name="email" onChange={handleProfileChange} value={profile?.email} autoComplete="off" />
                        </div>
                    </div>
                    <div className={styles.InputWrapper}>
                    ...
                    <div className={styles.InputWrapper}>
                        ...
                        <div className={styles.Input}>
                            ...
                            <input
                                ...
                                onFocus={(e) => (e.target.readOnly = false)}
                            />
                            {show ? <LuEyeOff onClick={() => setShow(false)} /> : <LuEye onClick={() => setShow(true)} />}
                        </div>
                    </div>
                    <p className={styles.info}>Current Password is needed for updating profile</p>
