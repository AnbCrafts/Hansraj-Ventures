"use client";
import { MediaDeviceMenu, useIsRecording, useMaybeLayoutContext, useRoomContext } from "@livekit/components-react";
import * as React from "react";
import { CameraSettings } from "./CameraSettings.jsx";
import { MicrophoneSettings } from "./MicrophoneSettings.jsx";
import styles from "./SettingsMenu.module.css";

export function SettingsMenu(props) {
	const layoutContext = useMaybeLayoutContext();
	const room = useRoomContext();
	const recordingEndpoint = import.meta.VITE_LK_RECORD_ENDPOINT;
	...
	const tabs = React.useMemo(() => Object.keys(settings).filter((t) => t !== undefined), [settings]);
