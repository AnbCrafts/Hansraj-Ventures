...
const BACKGROUND_IMAGES = [
	{ name: "Desk", path: "https://picsum.photos/800/600" },
	{ name: "Nature", path: "https://picsum.photos/800/600" },
];
...
export function CameraSettings() {
	...
	const camTrackRef = React.useMemo(() => {
		return cameraTrack ? { participant: localParticipant, publication: cameraTrack, source: Track.Source.Camera } : undefined;
				...
				<div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
					...
					{BACKGROUND_IMAGES.map((image) => (
						<button
							...
							className="lk-button"
							aria-pressed={backgroundType === "image" && virtualBackgroundImagePath === image.path.src}
							style={{
